...
CREATE OR REPLACE TABLE mart_cafe_location_intelligence AS
SELECT
    c.cafe_id,
    c.cafe_name,
...
FROM cafe_location_intelligence.staging.stg_unique_cafes c
LEFT JOIN cafe_location_intelligence.intermediate.int_cafe_nearby_features n
    ON c.cafe_id = n.cafe_id
LEFT JOIN cafe_location_intelligence.intermediate.int_cafe_distance_features d
